\section{Gewebeproben unter dem Mikroskop}
...
\begin{figure}[h!]
	...
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[angle=270, width=1\textwidth]{../images/02_pankreas.jpg}
		\caption{Objektiv 10x}
		\label{fig:02_pankreas}
	\end{subfigure}

	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[angle=270, width=1\textwidth]{../images/03_pankreas.jpg}
		\caption{Objektiv 20x}
